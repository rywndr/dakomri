...
export type StatusKepemilikanEKTP =
    | "Memiliki"
    | "Tidak Memiliki"
    | "Dalam Proses";
...
export type StatusTempatTinggal =
    | "Bersama orang tua"
    | "Rumah pribadi"
    | "Sewa/kontrak";
...
export type AksesLayananKesehatan =
    | "Puskesmas"
    | "Rumah Sakit"
    | "Klinik"
    | "Tidak Pernah";
...
export type PelakuDiskriminasi =
    | "Keluarga"
    | "Kerabat"
    | "Pelanggan"
    | "Lainnya";
...
export type CommunityFormApi = ReactFormExtendedApi<
    FormData,
    undefined | FormValidateOrFn<FormData>,
    undefined | FormValidateOrFn<FormData>,
    undefined | FormAsyncValidateOrFn<FormData>,
    undefined | FormValidateOrFn<FormData>,
    undefined | FormAsyncValidateOrFn<FormData>,
    undefined | FormValidateOrFn<FormData>,
    undefined | FormAsyncValidateOrFn<FormData>,
