...
const phoneSchema = z
  ...
  .regex(/^(\+62|62|0)[0-9]{9,12}$/, "Format nomor telepon tidak valid (contoh: +628123456789 atau 08123456789)");
...
export const section2Schema = z.object({
  ...
  statusKepemilikanEKTP: z.enum(["Memiliki", "Tidak Memiliki", "Dalam Proses"]),
});
...
export const section3Schema = z.object({
  ...
  statusTempatTinggal: z.enum(["Bersama orang tua", "Rumah pribadi", "Sewa/kontrak"]).optional(),
});
...
export const section5Schema = z.object({
  ...
  pendidikanTerakhir: z.enum(["SD", "SMP", "SMA/SMK", "Perguruan Tinggi", "Tidak Sekolah"]).optional(),
  statusPekerjaan: z.enum(["Bekerja", "Tidak Bekerja", "Pelajar Mahasiswa"]).optional(),
...
export const section8Schema = z.object({
  aksesLayananKesehatan: z.enum(["Puskesmas", "Rumah Sakit", "Klinik", "Tidak Pernah"]).optional(),
...
export const section10Schema = z.object({
  ...
  jenisDiskriminasi: z.array(z.enum(["Fisik", "Ekonomi", "Verbal", "Seksual", "Psikologi", "Sosial"])).optional(),
